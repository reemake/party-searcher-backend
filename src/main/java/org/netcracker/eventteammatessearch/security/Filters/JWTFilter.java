...
public class JWTFilter extends AbstractAuthenticationProcessingFilter {
    ...
    protected JWTFilter(@Value("/api/**") String defaultFilterProcessesUrl, @Lazy AuthenticationManager authenticationManager, @Lazy UserDetailsManager userDetailsManager) {
